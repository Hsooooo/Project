...
<section id="latest-news-block">
  <div class="container">
    <div class="row"> 
      ...
      <!--home article-->
      <article class="col-md-3 col-sm-6 col-xs-12">
        <header class="entry-header"> <a href="Updown.html"><img src="img/01-screenshot.jpg" alt="image 1"></a> 
          <a href="Updown.html"><h6>UP DOWN게임!! 모르는상대와 한정된 금액을걸고 게임을해보세요!</h6></a>
          </a> <a href="Updown.html">Web-design</a> </header>
      </article>
      <!--/home article --> 
